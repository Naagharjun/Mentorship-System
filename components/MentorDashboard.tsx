...
const MentorDashboard: React.FC<{
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            {/* Badges Header */}
            {badges.length > 0 && (
                <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl md:rounded-3xl p-4 sm:p-5 md:p-6 shadow-xl shadow-blue-500/20 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 transition-all group">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-[10px] sm:text-xs font-black text-slate-400 uppercase tracking-widest">Total Sessions</p>
                ...
                <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-purple-500/5 transition-all group">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-[10px] sm:text-xs font-black text-slate-400 uppercase tracking-widest">Active Mentees</p>
                    ...
                    <div className="flex items-end justify-between">
                        <h3 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">{new Set(acceptedRequests.map(r => r.menteeId)).size}</h3>
                        <span className="text-[10px] font-black px-3 py-1.5 bg-purple-100 text-purple-700 rounded-full uppercase tracking-wider mobile-hide">Growing Fast</span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                            ...
                            acceptedRequests.slice(0, 3).map((r) => {
                                ...
                                return (
                                    <div key={r.id} className="group flex flex-col sm:flex-row gap-4 sm:gap-5 p-4 sm:p-5 rounded-3xl hover:bg-white transition-all border border-transparent hover:border-slate-100 hover:shadow-lg hover:shadow-slate-200/30">
                                        <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl flex flex-col items-center justify-center text-white shadow-lg shadow-blue-500/20 group-hover:scale-105 transition-transform self-start min-w-[3.5rem]">
                                            <span className="text-[9px] sm:text-[10px] font-black leading-none uppercase mb-1 opacity-70">
                ...
                {/* Insight Panel */}
                <div className="bg-gradient-to-br from-slate-900 to-indigo-950 p-6 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] shadow-2xl flex flex-col justify-between relative overflow-hidden min-h-[200px]">
                ...
                {/* Feedback Section */}
                <div className="bg-white/70 backdrop-blur-md p-6 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] border border-slate-200/60 shadow-lg relative overflow-hidden h-full">
