...
const MenteeDashboard: React.FC<{
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            {/* Badges Header */}
            {badges.length > 0 && (
                <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl md:rounded-3xl p-4 sm:p-5 md:p-6 shadow-xl shadow-purple-500/20 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 transition-all group">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-[10px] sm:text-xs font-black text-slate-400 uppercase tracking-widest">Upcoming Sessions</p>
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-50 rounded-2xl flex items-center justify-center text-xl group-hover:scale-110 transition-transform">📅</div>
                    </div>
                    <div className="flex items-end justify-between">
                        <h3 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">{acceptedRequests.length}</h3>
                    </div>
                </div>
                <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-indigo-500/5 transition-all group">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-[10px] sm:text-xs font-black text-slate-400 uppercase tracking-widest">Completed Hours</p>
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-indigo-50 rounded-2xl flex items-center justify-center text-xl group-hover:scale-110 transition-transform">⭐</div>
                    </div>
                    <div className="flex items-end justify-between">
                        <h3 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">{acceptedRequests.length * 1.5}</h3>
                ...
                <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-purple-500/5 transition-all group">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-[10px] sm:text-xs font-black text-slate-400 uppercase tracking-widest">Skill Proficiency</p>
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-purple-50 rounded-2xl flex items-center justify-center text-xl group-hover:scale-110 transition-transform">👥</div>
                    </div>
                    <div className="flex items-end justify-between">
                        <h3 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">{skillProficiency}%</h3>
                        <span className="text-[10px] font-black px-3 py-1.5 bg-purple-100 text-purple-700 rounded-full uppercase tracking-wider mobile-hide">{skillProficiency > 70 ? 'Expert' : skillProficiency > 40 ? 'Growing Fast' : 'Just Starting'}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="bg-white/70 backdrop-blur-md p-6 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] border border-slate-200/60 shadow-lg relative overflow-hidden">
                    ...
                    <div className="space-y-5">
                        {acceptedRequests.length === 0 ? (
                            ...
                            acceptedRequests.slice(0, 3).map((r) => {
                                ...
                                return (
                                    <div key={r.id} className="group flex flex-col sm:flex-row gap-4 sm:gap-5 p-4 sm:p-5 rounded-3xl hover:bg-white transition-all border border-transparent hover:border-slate-100 hover:shadow-lg hover:shadow-slate-200/30">
                                        <div className="relative self-start">
                                            <UserAvatar name={r.mentorName} role="mentor" size={56} className="rounded-2xl shadow-lg group-hover:scale-105 transition-transform" />
                                            <div className="absolute -bottom-1 -right-1 w-7 h-7 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl flex items-center justify-center text-white text-[10px] font-black shadow-lg border-2 border-white">
                                        ...
                                        <div className="flex-1 py-1">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                <button
                                                    ...
                                                    className="px-4 sm:px-5 py-2 bg-emerald-100 text-emerald-700 text-[9px] sm:text-[10px] font-black rounded-xl hover:bg-emerald-200 transition-all uppercase tracking-wider active:scale-95"
                                                >
                                                    Message
                                                </button>
                                                <button
                                                    onClick={() => setReviewingMentor({ id: r.mentorId, name: r.mentorName })}
                                                    className="px-4 sm:px-5 py-2 bg-amber-100 text-amber-700 text-[9px] sm:text-[10px] font-black rounded-xl hover:bg-amber-200 transition-all uppercase tracking-wider active:scale-95"
                                                >
                                                    Review
                                                </button>
                                                <button
                                                    ...
                                                    className="px-4 sm:px-5 py-2 bg-slate-100 text-slate-500 text-[9px] sm:text-[10px] font-black rounded-xl hover:bg-rose-50 hover:text-rose-600 transition-all uppercase tracking-wider active:scale-95 disabled:opacity-50"
                                                >
                ...
                <div className="bg-gradient-to-br from-slate-900 to-indigo-950 p-6 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] shadow-2xl flex flex-col justify-between relative overflow-hidden min-h-[400px]">
